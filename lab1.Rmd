...
Peek first at the plots on the next page, then come back to see the code as needed.
...
Add your name to the YAML at the top of this file, delete the code and images for the statistics majors plots, delete the appendix below, delete this Exercise 4 section (basically, clean up the file!), delete grading details, and submit to Gradescope via Canvas.
...
- 5 points: uploading completed lab
- 5 points: accuracy and presentation of exercises
